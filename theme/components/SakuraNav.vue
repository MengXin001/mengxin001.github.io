...
<template>
  <header class="px-3 h-60px yya" :class="isHeaderActive ? 'yya' : ''" @mouseover="showYYA = false" @mouseleave="showYYA = false">
    ...
    <div ref="pcNavGSAP" :class="isHeaderActive ? '<md:relative' : 'md:relative'" class="text-sm text-gray-500 leading-5 h-full w-auto">
